<div class="max-w-3xl mx-auto px-4">
    <div class="flex items-center gap-3 mb-6">
        <a href="{{ route('productos.index') }}" class="inline-flex h-9 w-9 items-center justify-center rounded-full border border-zinc-200 dark:border-zinc-700 text-zinc-600 dark:text-zinc-300 hover:bg-zinc-50 dark:hover:bg-zinc-700" title="Volver a productos">
            <flux:icon.arrow-left class="size-4" />
            <span class="sr-only">Volver</span>
        </a>
        <h1 class="text-2xl md:text-3xl font-semibold text-gray-900 dark:text-gray-100">Agregar un nuevo producto</h1>
    </div>
    <form wire:submit.prevent="save" class="mt-6 space-y-6">
        ...
        <div class="pt-2">
            ...
            >
                <span wire:loading.remove>Agregar producto</span>
